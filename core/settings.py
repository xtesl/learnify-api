...
service_account_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), "serviceAccount.json")
...
#Email sending configuration for password reset
EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
EMAIL_HOST = 'smtp.gmail.com'
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = 'aimmanuel925@gmail.com'
EMAIL_HOST_PASSWORD = 'hfxr bvhi lidx bnpc'
